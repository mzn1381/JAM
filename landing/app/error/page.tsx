...
export const metadata: Metadata = {
  title: "صفحه خطا | قالب رایگان Next.js برای استارتاپ و SaaS",
  description: "این صفحه خطا برای قالب استارتاپ Next.js است",
  // other metadata
};
...
const ErrorPage = () => {
  return (
    <>
      <section dir="rtl" className="relative z-10 pb-16 pt-36 md:pb-20 lg:pb-28 lg:pt-[180px]">
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                <div className="mx-auto text-center mb-9">
                  <svg
                    className="w-full mx-auto text-center text-primary"
                    height="210"
                    viewBox="0 0 474 210"
                    fill="none"
                ...
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  صفحه‌ای که به دنبال آن بودید ممکن است منتقل شده، حذف شده یا وجود نداشته باشد.
                </p>
                <Link
                  href="/"
