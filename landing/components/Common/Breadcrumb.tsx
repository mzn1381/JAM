...
const Breadcrumb = ({ pageName, description }: { pageName: string; description: ReactNode }) => {
  return (
    <>
              ...
              <div className="text-end">
                <ul className="flex items-center md:justify-end">
                  <li className="flex items-center">
                    <Link href="/" className="pl-1 text-base font-medium text-body-color hover:text-primary">
                      Home
                    </Link>
                    <span className="ml-3 block h-2 w-2 rotate-45 border-b-2 border-l-2 border-body-color"></span>
                  </li>
