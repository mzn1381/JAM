    ...
    >
      <>
        <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
          برای دریافت آخرین به‌روزرسانی‌ها عضو شوید
        </h3>
        <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
          با عضویت در خبرنامه ما، از جدیدترین اخبار، مقالات و تخفیف‌های ویژه زودتر از دیگران باخبر شوید.
        </p>
        <div>
          <input
            type="text"
          ...
          <input
            ...
            className="border-stroke dark:text-body-color-dark dark:shadow-two mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:focus:border-primary dark:focus:shadow-none"
          />
          <button className="shadow-submit dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white duration-300 hover:bg-primary/90">
            عضویت در خبرنامه <small className="ms-1"> (بزودی) </small>
          </button>
          <p className="dark:text-body-color-dark text-center text-base leading-relaxed text-body-color">
            ما اسپم نمی‌فرستیم، پس خیالتان راحت باشد.
          </p>
        </div>
      </>
