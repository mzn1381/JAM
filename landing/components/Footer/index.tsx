        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 ms-3 inline-block">
                  <Image
                ...
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  مارا در شبکه های اجتماعی دنبال کنید و از آخرین اخبار و به‌روزرسانی‌های پیشکار باخبر شوید.
                </p>
                <div className="flex items-center">
                  ...
                  <a
                    href="https://www.linkedin.com/company/mypishkar/"
                    aria-label="social-link"
                    target="_blank"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">لینک های کمکی</h2>
                <ul>
                  <li>
                    <a
                      href="/blogs"
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">قوانین و مقررات</h2>
                <ul>
                  <li>
                    <a
                      href="/terms"
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">پشتیبانی و کمک</h2>
                <ul>
                  <li>
                    <a
                      href="/contact"
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              © {new Date().getFullYear()} Pishkar. All Rights Reserved. Created by تمام حقوق مادی و معنوی این سایت
              متعلق به پیشکار می‌باشد.
          ...
          <svg width="79" height="94" viewBox="0 0 79 94" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#00b3a6" stopOpacity="0.62" />
              ...
              >
                ...
                <stop offset="1" stopColor="#00b3a6" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
